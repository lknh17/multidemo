...
> **目标**: 在 Qwen2.5-VL-2B 上进行多模态指令微调，让模型学会理解图像并回答视觉相关问题。
>
...
t = AutoTokenizer.from_pretrained('Qwen/Qwen2.5-VL-2B-Instruct', trust_remote_code=True)
...
processor = AutoProcessor.from_pretrained("Qwen/Qwen2.5-VL-2B-Instruct", trust_remote_code=True)
